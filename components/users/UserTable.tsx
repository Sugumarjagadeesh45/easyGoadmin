// D:\Sugumar\taxi-store\components\users\UserTable.tsx
// Note: This appears to be a duplicate of components/admin/UsersTable.tsx. Consider removing one to avoid redundancy.
// If keeping, here's the corrected version.
"use client";
